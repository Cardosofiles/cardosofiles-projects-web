  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Mobile: fullscreen
        'inset-0 max-h-screen max-w-none translate-x-0 translate-y-0 overflow-y-auto rounded-none md:inset-auto md:top-[50%] md:left-[50%] md:max-w-lg md:translate-x-[-50%] md:translate-y-[-50%] md:rounded-lg',
        className
      )}
      {...props}
    >
